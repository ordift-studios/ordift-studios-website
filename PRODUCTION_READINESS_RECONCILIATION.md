...
**Task #284 (API endpoint sanity checks) is now complete.** Next up per the existing register: task #285 (fix all safely-fixable engineering issues found) — not started, pending separate instruction.
