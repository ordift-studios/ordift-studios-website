...
import { giveFeedbackAsInstructorAction, type ActionState } from "../../../../actions";

export function InstructorGiveFeedbackForm({ submissionId }: { submissionId: string }) {
  const [state, formAction, pending] = useActionState<ActionState, FormData>(giveFeedbackAsInstructorAction, null);
  return (
