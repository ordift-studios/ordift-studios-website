...
const HUB_GROUPS: HubGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Onboarding Documents & Agreements", href: "/admin/hr/onboarding-documents", description: "Everyone currently onboarding, and their real document/agreement readiness by relationship type." },
