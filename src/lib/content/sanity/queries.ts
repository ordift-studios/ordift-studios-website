...
export const workshopFragment = `{
  ...
  "instructorIds": coalesce(instructors[]._ref, []),
  "venueId": venue._ref,
  capacity,
  ...
  "experienceLevels": coalesce(experienceLevels, []),
  requiresPayment,
  "learningOutcomes": coalesce(learningOutcomes, []),
  "agenda": coalesce(agenda[]{"id": _key, time, title, description}, []),
  "gallery": coalesce(gallery[]${galleryImageFragment}, []),
  "faqs": coalesce(faqs[]{"id": _key, question, answer}, []),
  ${certificateFragment("certificate")},
  "testimonialIds": coalesce(testimonials[]._ref, []),
  "sponsorIds": coalesce(sponsors[]._ref, []),
...
export const pulseArticleFragment = `{
  ...
  "authorId": author._ref,
  "categoryIds": coalesce(categories[]._ref, []),
  "regionIds": coalesce(regions[]._ref, []),
  "opportunityTypeIds": coalesce(opportunityTypes[]._ref, []),
  tags,
  body,
  ...
  publishedAt,
  scheduledFor,
  "relatedArticleIds": coalesce(relatedArticles[]._ref, []),
  "relatedProjectIds": coalesce(relatedProjects[]._ref, []),
  "relatedWorkshopIds": coalesce(relatedWorkshops[]._ref, []),
  newsletterExcerpt,
  ${seoFragment("seo")},
