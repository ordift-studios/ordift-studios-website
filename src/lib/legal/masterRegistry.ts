...
const VERSION_SELECT =
  "id, master_id, version, status, approved_by, approved_at, effective_date, activated_at, retired_at, supersedes_id, legacy_code, public_slug, content_reference, document_hash, notes, created_at";
