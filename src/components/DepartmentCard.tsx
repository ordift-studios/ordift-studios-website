...
type DepartmentCardProps = {
  ...
  description: string;
  href: string;
  /** Department slug (e.g. "photography") — resolves the coherent icon fallback system in DepartmentIcon.tsx. Omit to keep the default Ordift monogram placeholder. */
  slug?: string;
};
...
export default function DepartmentCard({
  ...
  return (
    ...
    >
      <MediaPlaceholder aspectRatio="4/3" tone="light" icon={slug ? getDepartmentIcon(slug) ?? undefined : undefined} className="rounded-lg mb-4" />
